...
def get_double_red_mmi(cov_parts11, cov_parts22, cond_cov_parts11,
                       cond_cov_parts22, cond_cov_parts12, cond_cov_parts21):

    double_redundancy_mmi = 0
    all_mutual_info = (0.5 * np.log(np.array([cov_parts11/([cond_cov_parts11+0j]),
                                             cov_parts22/([cond_cov_parts22+0j]),
                                             cov_parts22/([cond_cov_parts12+0j]),
                                             cov_parts11/([cond_cov_parts21+0j])]))).real
    ...
    for j in range(len(all_mutual_info)):
        ...
        double_redundancy_mmi = np.min(np.nan_to_num(all_mutual_info))
